        ...
        productUI += `
              <div class = "col-md-3">
                    <div class = "card text-center mb-3 mt-3 card-product">
                        ...
                        <button class = "tryon bg-warning border-0 text-light rounded-lg" data-id = "${product.id}" data-type = "${product.type}" data-name = "${product.name}" data-desc = "${product.desc}"
                        data-imgsrcjpg = "${product.imgSrc_jpg}" data-imgsrcpng = "${product.imgSrc_png}">Try on </button>
                    </div>
              </div>
       `
      })
